...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1659351307);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 62);
user_pref("browser.newtabpage.activity-stream.impressionId", "{eafea035-670e-4492-9292-6cb59aabd13e}");
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1659337200);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1659351312546");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1659372912546");
user_pref("browser.search.countryCode", "TH");
user_pref("browser.search.region", "TH");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1659351310");
user_pref("browser.slowStartup.averageTime", 4543);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1659351311716");
...
user_pref("extensions.shield-recipe-client.user_id", "f9e60b49-4259-49c3-bbe2-695585a3c486");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"21d7064a-6b1f-444c-9475-73beffea2cd2\"}");
...
user_pref("toolkit.startup.last_success", 1659351303);
user_pref("toolkit.telemetry.cachedClientID", "c74fde7f-0271-44e3-b55b-78bea188edc1");
